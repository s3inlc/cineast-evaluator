 ...
 * Time: 15:31
 */
class EveryDayLevel2Achievement extends GameAchievement {
  
  /**
   * @return string
   */
  function getAchievementName() {
    return "Every day a game Level 2";
  }
  ...
  function getProgress($player) {
    ...
    return floor(min(100, $this->getMaxDaysInRow($player) / 4 * 100));
  }
}