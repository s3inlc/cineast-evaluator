 ...
 * Time: 15:31
 */
class EveryDayLevel4Achievement extends GameAchievement {
  
  /**
   * @return string
   */
  function getAchievementName() {
    return "Every day a game Level 4";
  }
  ...
  function getDescription() {
    return "Play at least one game per day for two weeks in row.<br>Gives 5% extra score";
  }
  ...
  function getProgress($player) {
    ...
    return floor(min(100, $this->getMaxDaysInRow($player) / 14 * 100));
  }
}