 ...
 * Time: 15:31
 */
class OAuthGoogleAchievement extends GameAchievement {
  ...
  function isReachedByPlayer($player) {
    ...
    foreach ($providers as $provider) {
      if ($provider->getType() == OAuthLogin::TYPE_GOOGLE) {
        return true;
      }
    }
  ...
  function getDescription() {
    return "Log in with your Google account<br>Gives 5% extra score";
  }
